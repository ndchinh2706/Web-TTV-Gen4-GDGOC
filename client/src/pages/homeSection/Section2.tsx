          ...
          <div className="flex flex-col lg:flex-row items-start gap-6 md:gap-12 px-2 md:px-8">
            <div className="flex-8/12">
              ...
              <p className="text-gray-600 text-base sm:text-lg md:text-xl leading-relaxed text-justify">
                Google Developer Groups - On Campus là chương trình được Google cấp quyền tổ chức và hỗ trợ, dành cho sinh viên đam mê CNTT và công nghệ Google. Năm 2024, đã có hơn 2000 chi nhánh tại hơn 100 quốc gia. 
              </p>
            </div>
